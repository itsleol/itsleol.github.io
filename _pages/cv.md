...
**Lai, Z.*** & Tang, Y. (Accepted & Under Revision) Beyond or within the binary? Constructing gendered meanings in generative AI use. *iConference 2025*.<br>
Chen, N., **Lai, Z.**, Li, J., Liu, Y., & Yan, P\*. (Accepted & Under Revision) See, Trust, and Interact: How AI Disclosure Shapes High School Students’ Trust. *iConference 2025*.<br>
